...
<section class=" mb-4">
	<div class="container">
		...
		<div class="row mb-3">
			...
			<div class="col-md-4 text-center mb-4" data-animate="left" data-delay="3">
				<figure class="medico">
					<img src="assets/img/medico2.jpg" alt=""  />
				</figure>
			</div><!-- col-lg-6  -->
